...
execute as @e[type=item,nbt={Tags:[cd_white],Item:{tag:{display:{}}}}] at @s if entity @e[type=armor_stand,distance=..1,sort=nearest,limit=1,tag=!cd_dist_white,tag=!global.ignore] run function city_districts:cities/white/found_district_white
